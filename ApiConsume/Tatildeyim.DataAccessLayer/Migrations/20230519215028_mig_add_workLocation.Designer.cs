...
namespace Tatildeyim.DataAccessLayer.Migrations
{
    ...
    [Migration("20230519215028_mig_add_workLocation")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Tatildeyim.EntityLayer.Concrete.About", b =>
                {
            ...
            modelBuilder.Entity("Tatildeyim.EntityLayer.Concrete.AppRole", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Tatildeyim.EntityLayer.Concrete.AppUser", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Tatildeyim.EntityLayer.Concrete.Booking", b =>
                {
            ...
            modelBuilder.Entity("Tatildeyim.EntityLayer.Concrete.Contact", b =>
                {
            ...
            modelBuilder.Entity("Tatildeyim.EntityLayer.Concrete.Guest", b =>
                {
            ...
            modelBuilder.Entity("Tatildeyim.EntityLayer.Concrete.Room", b =>
                {
            ...
            modelBuilder.Entity("Tatildeyim.EntityLayer.Concrete.SendMessage", b =>
                {
            ...
            modelBuilder.Entity("Tatildeyim.EntityLayer.Concrete.Service", b =>
                {
            ...
            modelBuilder.Entity("Tatildeyim.EntityLayer.Concrete.Staff", b =>
                {
            ...
            modelBuilder.Entity("Tatildeyim.EntityLayer.Concrete.Subscribe", b =>
                {
            ...
            modelBuilder.Entity("Tatildeyim.EntityLayer.Concrete.Testimonial", b =>
                {
            ...
            modelBuilder.Entity("Tatildeyim.EntityLayer.Concrete.WorkLocation", b =>
                {
                    b.Property<int>("WorkLocationID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<int>", b =>
                {
                    b.HasOne("Tatildeyim.EntityLayer.Concrete.AppRole", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<int>", b =>
                {
                    b.HasOne("Tatildeyim.EntityLayer.Concrete.AppUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Tatildeyim.EntityLayer.Concrete.AppUser", b =>
                {
                    b.HasOne("Tatildeyim.EntityLayer.Concrete.WorkLocation", "WorkLocation")
                        .WithMany("AppUsers")
